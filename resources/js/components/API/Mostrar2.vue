<template>
    ...
    <div class="col-12 m-0 p-0"  >
        <center><h3>¿Deseas buscar por Escuela y Grado?</h3></center>
        <div class="input-group mb-3" >
        <input class="form-control" type="text" v-model="search1" v-on:keyup.enter="searchData" placeholder="Buscar Escuela">
        <input class="form-control" type="text" v-model="search" v-on:keyup.enter="searchData" placeholder="Buscar Grado">
        ...
        <input class="form-control" type="date" v-model="search5" v-on:keyup.enter="searchData" placeholder="Buscar Date Final">
            ...
            <center><h3>¿Deseas buscar por Escuela o Grado?</h3></center>
        <div class="input-group mb-3" >
        <input class="form-control" type="text" v-model="search2" v-on:keyup.enter="searchData1" placeholder="Buscar Escuela">
        <input class="form-control" type="text" v-model="search3" v-on:keyup.enter="searchData1" placeholder="Buscar Grado">
        </div>
