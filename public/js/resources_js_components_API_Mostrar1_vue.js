...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    getTodos: function getTodos() {
      var _this = this;
      axios__WEBPACK_IMPORTED_MODULE_0___default().get('http://sicoep.org/api/students_by_department_municipality').then(function (response) {
    ...
    searchData: function searchData() {
      ...
      if (this.search1 && this.search && this.search4 && this.search5) {
        axios__WEBPACK_IMPORTED_MODULE_0___default().get('http://sicoep.org/api/students_by_department_municipality?municipality=' + this.search1 + '&department=' + this.search + '&dateStart=' + this.search4 + '&dateEnd=' + this.search5).then(function (res) {
    ...
    searchData1: function searchData1() {
      var _this3 = this;
      if (this.search2) {
        axios__WEBPACK_IMPORTED_MODULE_0___default().get('http://sicoep.org/api/students_by_department_municipality?municipality=' + this.search2).then(function (res) {
      ...
      if (this.search3) {
        axios__WEBPACK_IMPORTED_MODULE_0___default().get('http://sicoep.org/api/students_by_department_municipality?department=' + this.search3).then(function (res) {
          _this3.student = res.data;
        })["catch"](function (err) {
          console.log(err);
        });
